			...
			<form name="ctl00" method="post" action="${pageContext.request.contextPath}/user/addUser" id="f" onsubmit="return check()" >
				...
				<table class="tab_login" >
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="${pageContext.request.contextPath}/user/getImageCodes" />
							...
							<div class="text_left t1">
								<p class="t1">
									...
									<br/>
									<span id="codeInfo">${message }</span>
									<script type="text/javascript">
										$("#change").on("click",function(){
											$("#imgVcode").attr("src","${pageContext.request.contextPath}/user/getImageCodes?t="+Math.random());
										});
										$("#imgVcode").on("click",function(){
											//$("#imgVcode").attr("src","<s:url value="/user/getCode"/>?t="+Math.random());
											$(this).attr("src","${pageContext.request.contextPath}/user/getImageCodes?t="+Math.random());
										});
										function checkCode(){
