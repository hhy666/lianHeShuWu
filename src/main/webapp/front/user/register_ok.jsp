	...
	<body>
		...
		<div class="login_success">
			<div class="login_bj">
				...
				<h5>
					${user.nickname }，欢迎加入联大旧书屋网
				</h5>
				<h6>
					请牢记您的登录邮件地址：${user.email }<br/><br/>
					<span id="ss"></span>秒后自动跳转至联大旧书屋网首页
				...
				<ul>
					...
					<li>
						进入“
						<a href="#">我的书屋</a>”查看并管理您的个人信息
					</li>
					<li>
						<a href="${pageContext.request.contextPath}/main/main">浏览并选购商品</a>
					</li>
				</ul>
			</div>
		</div>
