	...
	<head>
	    ...
	    <script>
	        function change(bookId){
	            ...
	            location.href="${pageContext.request.contextPath}/cart/updateCart?bookId="+bookId+"&count="+count;
	        }
	    </script>
	</head>
	<body>
		...
		<div id="div_no_choice">
			...
			<c:if test="${cart eq null}">
				您还没有挑选商品[<a href='${pageContext.request.contextPath}/main/main'> 继续挑选商品&gt;&gt;</a>]
		    </c:if>
			</div>
		</div>
		...
		<c:if test="${cart ne null }">
			...
			<div class="choice_bord">
				<table class="tabl_buy" id="tbCartItemsNormal">
					...
					<!-- 购物列表开始 -->
					<c:forEach var="c" items="${cart.cartItems }">
					<tr class='td_no_bord'>
						...
						<td>
							<a href="${pageContext.request.contextPath}/main/queryOne?bookId=${c.key}">${c.value.book.name }</a>
						</td>
						<td class="buy_td_5">
						...
						<td>
							<a href="${pageContext.request.contextPath}/cart/deleteCart?bookId=${c.key}">删除</a>
						</td>
					</tr>
					</c:forEach>
				</table>
				...
				<div class="choice_balance">
					<div class="select_merch">
						<a href="${pageContext.request.contextPath}/main/main"> 继续挑选商品>></a>
					</div>
					<div class="total_balance">
						<div class="save_total">
							您共节省：
							<span class="c_red"> ￥<span id="total_economy">${cart.savePrice }</span> </span>
