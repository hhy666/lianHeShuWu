	...
	<body>
		...
		<table width="80%" border="0" align="center" cellspacing="0" cellpadding="5">
			...
			<tr>
				...
				<font color="red">书屋价：￥${book.dprice }</font>&nbsp;&nbsp;&nbsp;&nbsp;
				节省：￥${book.price - book.dprice}</td>
			</tr>
			<tr>
				<td colspan="2">
					<a href="${pageContext.request.contextPath}/cart/addCart?bookId=${book.bookId}">
		...
		<h2>编辑推荐:${book.editorRecomment }</h2>
		<p>&nbsp;&nbsp;</p>
		<hr style="border:1px dotted #666"/>
		<h2>内容简介:${book.contentAbstract }</h2>
		<p>&nbsp;&nbsp;</p>
		<hr style="border:1px dotted #666"/>
		<h2>作者简介:${book.authorAbstract }</h2>
		<p>&nbsp;&nbsp;</p>
		<hr style="border:1px dotted #666"/>
		<h2>目录:${book.director }</h2>
		<p>&nbsp;&nbsp;</p>
		<hr style="border:1px dotted #666"/>
		<h2>媒体评论:${book.mediaCommentary }</h2>
		<p>&nbsp;&nbsp;</p>
		<hr style="border:1px dotted #666"/>
		<h2>书摘插图</h2>
		<p>&nbsp;&nbsp;</p>
		...
		<div class="public_footer">
			<div class="public_footer_bottom">
				<div class="public_footer_icp" style="line-height: 48px;">
					Copyright (C) 联合旧书屋网 2004-2008, All Rights Reserved
