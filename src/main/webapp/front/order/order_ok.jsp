	...
	<body>
		...
		<div class="login_success">
			<div class="login_bj">
				...
				<h6>
					您刚刚生成的订单号是：<font color="red"><strong>${order.orderNo }</strong></font>，
					金额总计<font color="red"><strong>${order.total }</strong></font>
				</h6>

				<ul>
					<li class="nobj">
						您现在可以：还有<font color="red"><strong><spand id ="ss"></spand></strong></font>秒,回到首页！！！
						<script>
					var count = 6;
					var time = function(){
						count -=1;
					...
					<li>
						<a href="${pageContext.request.contextPath}/main/main">继续浏览并选购商品</a>
					</li>
				</ul>
			</div>
		</div>
