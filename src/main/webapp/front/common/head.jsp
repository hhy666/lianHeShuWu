	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> 
				<span class="little_n">
					| <a href="#" name="mydangdang" class="head_black12a">我的书屋</a> | 
		...
		<b>您好<font style="color:red">${user.nickname }</font>,欢迎光临联合旧书屋网</b>
		...
		<div class="head_head_list_left">
			<span class="head_logo">
				<a href="#" name="backtobook">
					<img src="${pageContext.request.contextPath}/back/images/lianda2.png" /> 
				</a> 
			</span>
		</div>
