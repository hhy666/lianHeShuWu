...
<body
	...
	<hr />
	<div align="center">
		<form action="${pageContext.request.contextPath}/book/addOne" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>名称：</td>
				...
				<tr>
					...
					<td rowspan="3">
						...
						<input type="file" name="cover" class="el-input__inner" id="file_upload1"	onchange="upload_review()">
					</td>
				</tr>
