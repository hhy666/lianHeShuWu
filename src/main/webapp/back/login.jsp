...
<script >
    function changeImage(){
        $("#imgVcode").attr("src","${pageContext.request.contextPath}/admin/getImageCodes?abc="+Math.random());
    } 
</script>
</head>
<body>
	<div class="head">
		<a href="http://www.lianhe.com"> <img src="${pageContext.request.contextPath}/back/images/lianda2.png" /></a>
		<div class="improve">
	...
	<div class="login_bg" style="width:960px; margin:0 auto;">
		<img src="http://a.lianhe.com/api/data/cpx/img/38930001/1" style="display: none;">
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
											<img id="imgVcode" src="${pageContext.request.contextPath}/admin/getImageCodes" class="Ucc_captcha Captcha-image" onClick="changeImage()">
										</a>
